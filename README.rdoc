...
I made examples for model and table - language.rb and language.json which you can find in <tt>app/services/examples</tt> folder. I use it for testing. So you can try already existing controller functionality after you will: 

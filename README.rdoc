...
What you need to do:
1. Add JSON file(<tt>Don't forget to change file name to model plural name. For example - 'languages.json'</tt>) to <tt>app/services/db/tables</tt> folder. I made example model - language.json which you can find in project root directory. I use it for testing so you can try already existing controller functionality after you will make what I wrote above.
